...
DATA_PATH = {
    ...
    'twitter15': {
                # text data
                'train': 'data/twitter15_data/twitter15_data/twitter2015/train.txt',
                'dev': 'data/twitter15_data/twitter15_data/twitter2015/valid.txt',
                'test': 'data/twitter15_data/twitter15_data/twitter2015/test.txt',
                # {data_id : object_crop_img_path}
                'train_auximgs': 'data/twitter15_data/twitter15_data/twitter2015/twitter2015_train_dict.pth',
                'dev_auximgs': 'data/twitter15_data/twitter15_data/twitter2015/twitter2015_val_dict.pth',
                'test_auximgs': 'data/twitter15_data/twitter15_data/twitter2015/twitter2015_test_dict.pth'
            },

    'twitter17': {
                # text data
                'train': 'data/twitter17_data/data/twitter2017/train.txt',
                'dev': 'data/twitter17_data/data/twitter2017/valid.txt',
                'test': 'data/twitter17_data/data/twitter2017/test.txt',
                # {data_id : object_crop_img_path}
                'train_auximgs': 'data/twitter17_data/data/twitter2017/twitter2017_train_dict.pth',
                'dev_auximgs': 'data/twitter17_data/data/twitter2017/twitter2017_val_dict.pth',
                'test_auximgs': 'data/twitter17_data/data/twitter2017/twitter2017_test_dict.pth'
            },
...
IMG_PATH = {
    ...
    'twitter15': 'data/twitter15_data/twitter15_data/twitter2015_images',
    'twitter17': 'data/twitter17_data/data/twitter2017_images',
}
...
AUX_PATH = {
    ...
    'twitter15': {
                'train': 'data/twitter15_data/twitter15_data/twitter2015_aux_images/train/crops',
                'dev': 'data/twitter15_data/twitter15_data/twitter2015_aux_images/val/crops',
                'test': 'data/twitter15_data/twitter15_data/twitter2015_aux_images/test/crops',
            },

    'twitter17': {
        'train': 'data/twitter17_data/data/twitter2017_aux_images/train/crops',
        'dev': 'data/twitter17_data/data/twitter2017_aux_images/val/crops',
        'test': 'data/twitter17_data/data/twitter2017_aux_images/test/crops',
            }
}
